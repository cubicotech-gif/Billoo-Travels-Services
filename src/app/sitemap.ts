...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${BASE}/blog/tips-comfortable-hajj`, changeFrequency: "monthly" as const, priority: 0.65 },
    { url: `${BASE}/blog/istanbul-muslim-travelers-paradise`, changeFrequency: "monthly" as const, priority: 0.65 },
