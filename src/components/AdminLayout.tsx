...
const icons = {
  ...
  Hajj: (c: string) => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5"><rect x="4" y="6" width="16" height="14" rx="1"/><path d="M4 12h16M8 2l4 4 4-4"/></svg>,
  ...
  Reviews: (c: string) => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14l-5-4.87 6.91-1.01L12 2z"/></svg>,
...
const NAV = [
  ...
  { label: "Hajj Campaign", href: "/admin/hajj-campaign", icon: "Hajj" },
  ...
  { label: "Google Reviews", href: "/admin/reviews", icon: "Reviews" },
