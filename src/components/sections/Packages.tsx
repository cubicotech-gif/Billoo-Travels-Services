      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {filtered.map((p, i) => (
            <ScrollReveal key={p.id} delay={i * 0.1}>
              <Link href={`/packages/${p.id}`} className="block no-underline h-full">
                  ...
                  <div className="p-5 pb-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-accent font-heading text-[13px] font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
                        View Details <ArrowIcon size={14} color="#4DA3E8" />
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="text-center mt-10">
            ...
            >
              Browse All Packages <ArrowIcon size={14} color="currentColor" />
            </Link>
          </div>
        </ScrollReveal>
      </div>
